...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-cognito-jwt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9867&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-cognito-jwt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-cognito-jwt` can be installed with:

```
conda install django-cognito-jwt
```

It is possible to list all of the versions of `django-cognito-jwt` available on your platform with:
